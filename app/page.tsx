    ...
    <main id="top" className="relative flex min-h-screen flex-col bg-[#07090d]">
      ...
      <header className="fixed inset-x-0 top-0 z-50 px-4 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-white/10 bg-[#07090d]/70 px-4 py-2.5 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link
              href="/auth/sign-up"
              className="rounded-full bg-[#9333ea] px-4 py-2 text-sm font-semibold text-white shadow-[0_8px_30px_-8px_rgba(147,51,234,0.8)] transition-colors hover:bg-[#a855f7]"
            >
              Criar conta
            </Link>
          </div>
      ...
      <section id="grafico" className="relative scroll-mt-24 px-6 py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-[#9333ea]/30 bg-[#9333ea]/10 px-4 py-1.5 text-xs font-semibold text-[#c084fc]">
            ...
            <p className="mt-5 max-w-lg text-pretty text-base leading-relaxed text-white/60 md:text-lg">
              ...
              Veja abaixo uma prévia do gráfico que você usa na plataforma Kodilex.
            </p>

            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-[#9333ea]/20 text-[#c084fc]">
            ...
            <Link
              href="/auth/sign-up"
              className="mt-8 inline-flex rounded-xl bg-[#9333ea] px-8 py-3.5 text-sm font-bold text-white shadow-[0_10px_40px_-8px_rgba(147,51,234,0.8)] transition-all hover:bg-[#a855f7]"
            >
              Começar a operar
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden px-6 py-20 sm:py-28">
        <div className="absolute left-1/2 top-1/2 h-96 w-[60rem] max-w-[95%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#9333ea]/10 blur-[140px]" />
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <div className="relative mx-auto mt-12 max-w-4xl">
            <div className="absolute -inset-4 rounded-3xl bg-[#9333ea]/20 blur-2xl" />
            <img
              src="/images/kodilex-showcase.png"
              alt="Plataforma de trading da Kodilex com gráfico de candles e painel de operações"
              className="relative w-full rounded-2xl border border-white/10 shadow-[0_30px_80px_-20px_rgba(147,51,234,0.5)]"
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <div
                key={f.title}
                className="group rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-colors hover:border-[#9333ea]/40 hover:bg-[#9333ea]/[0.06]"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#9333ea]/15 text-[#c084fc] transition-colors group-hover:bg-[#9333ea]/25">
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-8 sm:grid-cols-4 sm:gap-8">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <p className="bg-gradient-to-r from-[#a855f7] to-[#c084fc] bg-clip-text text-3xl font-extrabold text-transparent sm:text-4xl">
                  {s.value}
                </p>
      ...
      <section className="relative overflow-hidden px-6 py-24">
        <div className="absolute left-1/2 top-1/2 h-72 w-[50rem] max-w-[95%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#9333ea]/15 blur-[130px]" />
      ...
      <footer className="relative border-t border-white/10 px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} Kodilex Broker. Todos os direitos reservados.
          </p>
        </div>
      </footer>
    </main>
